...
- Checkpoint A1.0:
	...
	- A1T2 lines [20pts]
	- A1T3 flat triangles [25pts]
		- clippling [10pts]
		- rasterization [15pts]
	- A1T4 depth + blending [5pts]
- Checkpoint A1.5:
	- A1T5 interpolation [25pts]
		- screen-space [5pts]
		- perspective-correct [10pts]
		- derivatives [10pts]
	- A1T6 mip-mapping [25pts]
		- sampling [10pts]
		- generation [10pts]
		- lod [5pts]
	- A1T7 supersampling [15pts]
		- storage [5pts]
		- for (samples) [5pts]
		- resolve [5pts]
...
[<img src="A1/A1T2-cubes-before.png" width=250>](A1/A1T2-cubes-after.png)
