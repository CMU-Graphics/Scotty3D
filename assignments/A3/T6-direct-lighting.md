...
Here are `cbox.s3d` and `cbox_lambertian.s3d` without (left) and with (right) area light sampling (32 samples, max depth = 8):

<p align="center"><img src="images/cbox_importance.png"></p>
