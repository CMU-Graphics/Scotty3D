...
std::vector< Vec3 > Skeleton::gradient_in_current_pose() const {
    ...
    // Computes the gradient (partial derivative) of IK energy relative to each bone's Bone::pose.
	// the passed 'pose' gives the current transformation for every bone.
